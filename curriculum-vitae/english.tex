...
\begin{document}
    ...
    \begin {flushright} \begin {minipage} [t] {\rightcolumwidth\textwidth}
        ...
        I am looking for a role where I can grow and learn from experienced team members, while drawing on project expercience I have already executed.
    \end {minipage}
    \end {flushright}
    ...
    \begin {minipage} [t] {\rightcolumwidth\textwidth}
        ...
        \hspace* {6px} \textcolor{namebottomtxt} {September 2020 - Present} \\ [4px]
        Specialized in Computer Science and Artificial Intelligence \\ [4px]
