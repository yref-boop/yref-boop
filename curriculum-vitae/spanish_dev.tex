...
\begin{document}
    ...
    \begin {flushright} \begin {minipage} [t] {\rightcolumwidth\textwidth}
        Estudiante de Ingeniería Informática de 20 años, aspirante a ser desarrollador software. Disfruto de rosolver problemas así como de comprender el funcionamiento interno de sistemas complejos o conceptos teóricos, igual que colaborar con otros \\ [3px]
        Busco un puesto donde pueda precer y aprender de compañeros más experimentados, mientras aporto experiencia en proyectos ya ejecutados.
    \end {minipage}
    \end {flushright}
    ...
    \begin {minipage} [t] {\rightcolumwidth\textwidth}
        ...
        \href {https://estudos.udc.es/en/study/start/614G01V01} {\textbf {Grado Bilingüe (Esp, Ing) en Ingeniería Informática}}\\
