<image src="https://readme-typing-svg.herokuapp.com?duration=3500&width=550&height=95&font=Source+Code+Pro&size=17&color=FFFFFF&multiline=true&&lines=hello+world!+(+´+▽+`+)ノ;i+am+an+aspiring+software+developer;with+still+so+much+to+learn+and+debug;(+〃+▽+〃+)ゞ+">
...
- i am fluent in english, galician and spanish and understand some basic french (even though i seem to be unable to push commits without typos)
...
<img src="https://img.shields.io/badge/-Notion-302D41?style=for-the-badge&logo=Notion&logoColor=white"/> <img src="https://img.shields.io/badge/-Obsidian-302D41?style=for-the-badge&logo=Obsidian&logoColor=white"/><br/>
